---
title: Extract JSON
description: Use to_json() to get bounding boxes, layout data, and structured page content for custom pipelines.
---
...
<CardGroup cols={2}>
  ...
  <Card title="Extract Markdown" icon="markdown" href="/guides/extract-markdown">
    Use to_markdown() when you need clean readable output instead.
  </Card>
  <Card title="Tables" icon="table" href="/guides/tables">
    Table block structure and Markdown rendering.
  </Card>
  <Card title="Word-Level Extraction" icon="text-size" href="/guides/word-level-extraction">
    Extract individual words with coordinate data.
  </Card>
</CardGroup>
---
title: Chunk Schema
description: Full schema for each page chunk returned when `pageChunks=true` is passed to [ToMarkdown()](/dotnet/api/PdfExtractor#tomarkdown) or [ToText()](/dotnet/api/PdfExtractor#totext).
icon: "layer-group"
---
...
<img
  ...
  alt="PDF4LLM Chunk Schema Diagram"

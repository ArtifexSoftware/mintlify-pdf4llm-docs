---
title: Extract Text
description: Use [ToText()](/dotnet/api/to-text) to get clean, plain text output stripped of all Markdown formatting.
icon: "text"
---
...
See [OCR](/guides/ocr) for a full walkthrough of Tesseract installation, language codes, and patterns for mixed documents.

---

<Note>
  For the full API signature, see the [ToText() API reference](/api-reference/to-text).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Page Selection & Chunking" icon="floppy-disk" href="/guides/page-chunking">
    Split output into pages or token-bounded chunks.
  </Card>

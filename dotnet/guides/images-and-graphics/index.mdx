...
<Note>
  For the full API signature, see the [ToMarkdown() API reference](/dotnet/api/to-markdown).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Page Selection & Chunking" icon="floppy-disk" href="/dotnet/guides/page-chunking">
    Write Markdown and image files for specific pages.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Extract Markdown" icon="markdown" href="/python/guides/extract-Markdown/index">
    Preserve structure and formatting for LLM pipelines.
  </Card>
  <Card title="Extract Text" icon="text" href="/python/guides/extract-Text/index">
    Get clean, plain text output.
  </Card>
  <Card title="Tables" icon="table" href="/python/guides/tables/index">
